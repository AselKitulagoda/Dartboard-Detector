...
#include <highgui.hpp>		  //adjust import locations
#include <opencv/cxcore.hpp>    //depending on your machine setup
...
int main() {
	...
	Mat image(256, 256, CV_8UC3, Scalar(0, 0, 255)); // first 0 in scalar indicates blue
